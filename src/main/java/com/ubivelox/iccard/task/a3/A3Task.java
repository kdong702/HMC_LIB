    ...
    public HmcProtocol.Response doLogic(HmcProtocol.Request request, long sessionId, String transId) {
        ...
        try {
            ...
            if (a2Req.isScpType01()) {
                ...
                long encKeyId = findObj(sessionId, Constants.INIT_KEY_LABEL, transId);
                ...
                log.info("cc1 = {}", HexUtils.toHexString(cc1));


//                byte[] macDkData = makeDkDataWithTag(a2Req.getKdd(), 2);
//                log.info("macDkData = {}", HexUtils.toHexString(macDkData));
//                SecretKeySpec macDkKey = encAndMakeKey(sessionId, encKeyId, macDkData, IPkcsMechanism.DES2_DES3_ECB);
//
//                byte[] kekDkData = makeDkDataWithTag(a2Req.getKdd(), 3);
//                log.info("kekDkData = {}", HexUtils.toHexString(kekDkData));
//                SecretKeySpec kekDkKey = encAndMakeKey(sessionId, encKeyId, kekDkData, IPkcsMechanism.DES2_DES3_ECB);
            }
